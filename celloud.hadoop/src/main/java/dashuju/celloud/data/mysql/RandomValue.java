...
public class RandomValue {
	...
	public static String getTel() {
		...
		String second = ""+random.nextInt(10)+random.nextInt(10)+random.nextInt(10)+random.nextInt(10);
		String third = ""+random.nextInt(10)+random.nextInt(10)+random.nextInt(10)+random.nextInt(10);
	...
	public static String getRoad() {
		...
		String pro = province[index];
		index = getNum(0, road.length - 1);
